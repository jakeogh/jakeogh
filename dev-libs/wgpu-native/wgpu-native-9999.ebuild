...
# Vendored crates list — DO NOT MODIFY manually
CRATES="
	aho-corasick-1.1.3
...
# ✅ This is safe: cargo_crate_uris is allowed because `cargo` eclass handles it
...
src_unpack() {
	git-r3_src_unpack
	cargo_live_src_unpack  # Handles crate vendoring
}
...
src_install() {
	...
	# ✅ Install headers from correct locations
	insinto /usr/include/webgpu
	doins include/webgpu.h || die "Failed to install webgpu.h"
