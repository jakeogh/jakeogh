...
src_prepare() {
	...
	sed -i -e 's/CXXFLAGS="-stdlib=libc++" LDFLAGS="-lc++" ./configure $$config_flags LIBS="$$add_libs"/CXXFLAGS="-stdlib=libc++" ./configure $$config_flags LIBS="$$add_libs"/g' curl-impersonate-9999/Makefile.in
	default
}
